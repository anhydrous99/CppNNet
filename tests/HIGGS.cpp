...
int main(int argc, char *argv[]) {
  ...
  // Create Layers
  std::shared_ptr<Neural_Layer> layer1 = std::make_shared<Neural_Layer>(150, inp, activation_function::ReLU);
  std::shared_ptr<Neural_Layer> layer2 = std::make_shared<Neural_Layer>(100, 150, layer1, activation_function::ReLU);
  ...
  // Create Trainer
  Neural_Trainer trainer(layer3, 0.001);
