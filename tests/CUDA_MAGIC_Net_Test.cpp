...
int main() {
  ...
  // Create Layers
  std::shared_ptr<Neural_Layer> layer1 = std::make_shared<Neural_Layer>(5, inp, activation_function::Logistic);
  std::shared_ptr<Neural_Layer> layer2 = std::make_shared<Neural_Layer>(out, 5, layer1);
